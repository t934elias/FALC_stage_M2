...
# Initializes the default client pointing to http://localhost:11434
client = Client()
...
print(f"cosine pondere: {cosin_distance(results_ori, results_pred)}")
...
print(f"cosine pondere: {cosin_distance(results_ori, results_ref)}")
...
print(f"cosine pondere: {cosin_distance(results_pred, results_ref)}")
