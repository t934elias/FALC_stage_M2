...
def save_results_to_csv(filename, source_text, predicted_text, reference_text, metrics, emo_ori, emo_pred, emo_ref, dist1, dist2, dist3):
    ...
    row = {
        ...
        # euclidean distances
        "dist_ori_pred": {"distance": cosinie_distance(emo_ori, emo_pred), "other_val": dist1},
        "dist_ori_ref": {"distance": cosinie_distance(emo_ori, emo_ref), "other_val": dist2},
        "dist_pred_ref": {"distance": cosinie_distance(emo_pred, emo_ref), "other_val": dist3},
